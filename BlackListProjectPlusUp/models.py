...
class BlacklistUser(Model):
    ...
    target_id = fields.IntField(index=True, description='字段类型：1-uid,2-设备,3-IP')
    ...
    modify_user = fields.IntField(description='操作者id',default=0)
    describe = fields.CharField(max_length=500, description='加入黑名单的原因', null=True)
